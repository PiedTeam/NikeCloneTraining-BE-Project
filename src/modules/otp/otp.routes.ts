...
*/
otpRouter.post('/send-otp-phone', phoneNumberValidator, wrapAsync(sendOtpPhoneNumberController))
...
*/
otpRouter.post('/send-otp-email', emailValidator, wrapAsync(sendOtpMailController))
